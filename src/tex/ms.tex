...
\begin{figure*}
    \centering
    \includegraphics[width = 0.9\textwidth]{figures/self_test_ims.pdf}
    \includegraphics[width = 0.75\textwidth]{figures/self_test_post_corner.pdf}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.5\textwidth]{figures/ESO_349_31_post_corner.pdf}
    \includegraphics[width=0.3\textwidth]{figures/ESO_349_31_ims_post.pdf}
    \includegraphics[width=0.5\textwidth]{figures/ESO_540_32_post_corner.pdf}
    \includegraphics[width=0.3\textwidth]{figures/ESO_540_32_ims_post.pdf}
    \caption{Inference on two galaxies in the sculptor group, ESO 294-010 on top and ESO 410-005 on the bottom. In general really good agreement with other measurements and the images from the posterior, by eye, look a lot like the observed images. I'm not sure whether to include the stellar masses. We are biased a little low but that could be chocked up to some normalization issues that we should look into.}
    \script{plot_scul_dw.ipynb}
    \label{fig:sdw_3mpc}
