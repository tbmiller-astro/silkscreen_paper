...
\begin{figure*}
    \centering
    \includegraphics[width=0.6\textwidth]{figures/ESO_294_10_post_corner.pdf}
    \includegraphics[width=0.35\textwidth]{figures/ESO_294_10_ims_post.pdf}
    \caption{Caption}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.6\textwidth]{figures/ESO_410_05_post_corner.pdf}
    \includegraphics[width=0.4\textwidth]{figures/ESO_410_05_ims_post.pdf}
    \caption{Caption}
    \script{plot_scul_dw.ipynb}
    \label{fig:eso41005}
\end{figure*}
