...
% Title
\title{Directly inferring Distances and Physical Properties of stellar system using Simulation Based Inference}
...
\begin{figure*}
    \centering
    \includegraphics[width = 0.8\textwidth]{figures/self_test_post_corner.pdf}
    \includegraphics[width = 0.8\textwidth]{figures/self_test_ims.pdf}
    \caption{Plotting the results of a simple injection-recovery test. Seems to be pretty good although it is a little too confident about the stellar population parameters}
    \script{plot_self_test.ipynb}
    \label{fig:self_test_post}
\end{figure*}

\begin{figure}
    \centering
    \includegraphics[width = 0.95\columnwidth]{figures/self_test_sbc.pdf}
    \caption{Plotting the results of a simple injection-recovery test. Seems to be pretty good although it is a little too confident about the stellar population parameters}
    \script{plot_self_test.ipynb}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.5\textwidth]{figures/ESO_294_10_post_corner.pdf}
    \includegraphics[width=0.3\textwidth]{figures/ESO_294_10_ims_post.pdf}
    \includegraphics[width=0.5\textwidth]{figures/ESO_410_05_post_corner.pdf}
    \includegraphics[width=0.3\textwidth]{figures/ESO_410_05_ims_post.pdf}
    \caption{Caption}
